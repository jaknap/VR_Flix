...
/***/ function(module, exports) {
    ...
    AFRAME.registerComponent('video-controls', {
      ...
      update: function (oldData) {
        ...
        this.bar.setAttribute("width", "0.6");
        this.bar.setAttribute("position", "-3.3 -0.7 -3.06");


        this.play_image.setAttribute("height", "0.3");
        this.play_image.setAttribute("width", "0.3");
        this.play_image.setAttribute("position", "-4.2 -0.7 -3.06");
